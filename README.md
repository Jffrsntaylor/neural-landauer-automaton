...
- `train.py` — Training loop, entropy plot export (`assets/entropy_history.png`), checkpoints in `checkpoints/`.
- `simulate.py` — PBH experiment and GIF export (`assets/simulation_output.gif`).
